        ...
        {fibonacciPoints.map((point, index) => (
          <button
            ...
            className={`p-4 rounded-lg text-lg font-semibold transition-all transform hover:scale-105 cursor-pointer ${
              currentUser?.vote === point.toString()
      ...
      {isModerator && (
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="w-full px-6 py-3 bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Reveal Results
          </button>
        </div>
